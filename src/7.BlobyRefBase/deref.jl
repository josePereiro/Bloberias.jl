...
# public interface
deref(ref::BlobyRef{:vBlob, vBlob}) = _deref_vblob(ref)
deref(vb::vBlob, ::BlobyRef{:vBlob, vBlob}) =  vb
deref(bb::BlobBatch, ref::BlobyRef{:vBlob, vBlob}) =  _deref_vblob(bb, ref)
deref(B::Bloberia, ref::BlobyRef{:vBlob, vBlob}) =  _deref_vblob(B, ref)

bloberia(ref::BlobyRef{:vBlob, vBlob}) = _deref_bloberia(ref)
blobbatch(ref::BlobyRef{:vBlob, vBlob}) = _deref_blobbatch(ref)
vblob(ref::BlobyRef{:vBlob, vBlob}) = _deref_vblob(ref)

## --.--. - .-. .- .--.-.- .- .---- ... . .-.-.-.- 
# vBlobVal

# unsave
_deref_vblobval(vb::vBlob, ref::BlobyRef{lT, rT}) where rT where lT =
...
# public interface
deref(ref::BlobyRef{:vBlobVal, rT}) where rT = _deref_vblobval(ref)
deref(vb::vBlob, ref::BlobyRef{:vBlobVal, rT}) where rT = _deref_vblobval(vb, ref)
deref(bb::BlobBatch, ref::BlobyRef{:vBlobVal, rT}) where rT = _deref_vblobval(bb, ref)
deref(B::Bloberia, ref::BlobyRef{:vBlobVal, rT}) where rT = _deref_vblobval(B, ref)

bloberia(ref::BlobyRef{:vBlobVal, rT}) where rT = _deref_bloberia(ref)
blobbatch(ref::BlobyRef{:vBlobVal, rT}) where rT = _deref_blobbatch(ref)
vblob(ref::BlobyRef{:vBlobVal, rT}) where rT  = _deref_vblob(ref)
...
deref(db::vBlob, ref::BlobyRef{:dBlobVal, rT}) where rT = _deref_dblobval(db, ref)
